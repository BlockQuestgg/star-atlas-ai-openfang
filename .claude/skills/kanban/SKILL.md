...
```markdown
## Narrative
- 2026-03-13: Discovered the auth flow must support device-based MFA; shifted approach to use WebAuthn. (by @assistant)
```
...
- `tags` — (optional) List of labels. Suggested tags for this project: `researcher`, `brainstorm`, `pip-advisor`, `knowledge-keeper`, `governance`, `lore`, `game`, `builder`, `config`, `vault`, `discord`, `infrastructure`.
...
assignee: "@claude"
due_date: 2026-03-28
tags: [researcher, config]
---

# Configure Researcher Hand Schedule

Set up the sa-researcher Hand with 4-hour research cycles.

## Acceptance Criteria
- Hand config file created with correct schedule.
- Web search and vault read capabilities enabled.
- Output writes to vaults/knowledge/inbox/.
```
